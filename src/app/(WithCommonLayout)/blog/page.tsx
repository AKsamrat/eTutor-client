...
const BlogPage: React.FC = () => {
  ...
  return (
    <section>
      ...
      <div
        className={`max-w-6xl mx-auto px-4 py-8 ${darkMode ? "bg-gray-900 text-white" : "bg-white text-gray-800"
          }`}
      >
          ...
          <div className="animate-fade-in">
            ...
            >
              ...
              <div className="p-6">
                ...
                <div
                  className={`flex items-center ${darkMode ? "text-gray-400" : "text-gray-600"
                    } mb-6`}
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {blogs
                    ...
                    .map((blog) => (
                      <div
                        key={blog.id}
                        className={`flex gap-4 cursor-pointer ${darkMode ? "hover:bg-gray-700" : "hover:bg-gray-50"
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      <div
                        className={`flex items-center ${darkMode ? "text-gray-500" : "text-gray-500"
                          }`}
                      >
